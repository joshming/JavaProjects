...
public class Play {
	...
	private static Icon[] figures; // Data structure to store icons
	private static Gui window;
	private static final String MOBILE_FIGURE = "user";// Icon that can be
														// moved by user
	private static final String FIGURE_KILLED = "killed";// Icon destroyed
	private static final int SUCCESS = -2; // Icon was successfully moved
	private static final int HIT_BORDER = -1; // Icon could not move as it
	...
	public static void main(String args[]) {
		...
		int[] progFig; // Icons controlled by computer
		...
		mover = new MoveFigure(window); // and read input icons
